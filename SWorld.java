...
public class SWorld extends World
{
    ...
    public boolean minionL = false; 
    static int bananas = 0; //defines how much ammo the player has
    static int lives = 3; //defines how many lives the player has
    //determines whether mario is moving left or right
    /**
